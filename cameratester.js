class CameraTester extends Window {
	constructor(params) {
		...
		this.controlButton = this.AddToolbarButton("Picture controls", "mono/personalize-light.svg");
		this.flipButton    = this.AddToolbarButton("Horizontal flip", "mono/horizontalflip-light.svg");
