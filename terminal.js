class Terminal extends Window {
	...
	InitializeComponents() {
		this.SetupToolbar();
		this.connectButton = this.AddToolbarButton("Connect", "mono/connect-light.svg");
		this.optionsButton = this.AddToolbarButton("Options", "mono/wrench-light.svg");
		this.AddToolbarSeparator();
		this.sendKeyButton = this.AddToolbarButton("Send key", "mono/keyboard-light.svg");
		this.pasteButton = this.AddToolbarButton("Paste", "mono/clipboard-light.svg");
